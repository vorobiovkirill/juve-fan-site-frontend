import { Newspost } from 'generated/types-and-hooks'
...
export const FeedItem: React.FC<FeedItemProps> = ({ createdAt = '', imageUrl = '', title = '', slug = '' }) => {
    const publishDate = getPublishDate(createdAt);

    return (
        <Link className="w-full" href={`news/${slug}`}>
